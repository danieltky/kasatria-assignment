...
import { TrackballControls } from '../vendor/threejs/controls/TrackballControls.js';
	...
	// function elementClickHandler(i, tempE){
	// 	// Get the clicked element
	// 	const element = targets.simple[i / 5];
		
	// 	const symbolElement = element.element.querySelector('.symbol');

	// 	if (symbolElement) {
	// 		symbolElement.textContent = 'No';
	// 		console.log('Element clicked:', i, tempE);
	// 	} else {
	// 		console.log("Symbol element not found within the clicked element.");
	// 	}
	// }
